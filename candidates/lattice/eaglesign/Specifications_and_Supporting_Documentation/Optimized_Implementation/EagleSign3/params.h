...
// ------------------------------------------
#define CRYPTO_PUBLICKEYBYTES CRYPTO_EAGLESIGN_PUBLICKEYBYTES
#define CRYPTO_SECRETKEYBYTES CRYPTO_EAGLESIGN_SECRETKEYBYTES
#define CRYPTO_BYTES CRYPTO_EAGLESIGN_BYTES
#endif
