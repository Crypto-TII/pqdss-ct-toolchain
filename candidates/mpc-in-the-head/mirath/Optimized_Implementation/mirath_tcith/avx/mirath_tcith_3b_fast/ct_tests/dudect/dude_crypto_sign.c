...
void prepare_inputs(dudect_config_t *c, uint8_t *input_data, uint8_t *classes) {
    FILE *keys;
    keys = fopen("candidates/mpc-in-the-head/mirath/dudect/mirath_tcith_3b_fast/mirath_sign/keys.txt", "a");
...
int main(int argc, char **argv)
{
    ...
    FILE *distributions;
    distributions = fopen("candidates/mpc-in-the-head/mirath/dudect/mirath_tcith_3b_fast/mirath_sign/measurements_mirath_tcith_3b_fast.txt", "w");
