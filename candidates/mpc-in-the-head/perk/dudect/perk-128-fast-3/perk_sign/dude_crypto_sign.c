...
static_distribution = fopen("candidates/mpc-in-the-head//perk/dudect/perk-128-fast-3/perk_sign/static.txt", "w");
random_distribution = fopen("candidates/mpc-in-the-head//perk/dudect/perk-128-fast-3/perk_sign/random.txt", "w");
