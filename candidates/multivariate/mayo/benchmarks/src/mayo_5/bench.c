...
{
	size_t i = 0;
	size_t iterations = TOTAL_ITERATIONS;
	//size_t min_msg_len = MINIMUM_MSG_LENGTH;
	//size_t max_msg_len = MAXIMUM_MSG_LENGTH;
	size_t mlen = 0;
	size_t default_mlen = DEFAULT_MESSAGE_LENGTH;
	size_t smlen[TOTAL_ITERATIONS] = {0};
	int pass;
	...
	*cc_sample =(ticks *)malloc(iterations * sizeof(ticks));
	...
	printf("Candidate: mayo\n");
	printf("Security Level: lvl5\n");
	printf("Instance: src/mayo_5\n");
