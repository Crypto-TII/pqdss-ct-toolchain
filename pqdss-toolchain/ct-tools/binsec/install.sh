...
if ! opam install bitwuzla
then
  echo 'bitwuzla could not be installed.'
  exit 1
fi


#if ! opam install bitwuzla-cxx
#then
#  echo 'bitwuzla-cxx could not be installed.'
#  exit 1
#fi

if ! opam install z3
then
  echo 'z3 could not be installed.'
  exit 1
fi
