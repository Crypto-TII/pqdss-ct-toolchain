...
def compile_run_raccoon(tools_list, signature_type, candidate, optimized_imp_folder,
    ...
    build_candidate.generic_init_compile_with_sh(tools_list, signature_type, candidate,
                                                 optimized_imp_folder, instance_folders_list,
                                                 rel_path_to_api, rel_path_to_sign, rel_path_to_rng,
                                                 add_includes, build_folder, sh_script,  rng_outside_instance_folder)
...
def run_cli_candidate(args_parse):
    ...
    arguments = f'''{list_of_tools}, f'{type_based_signature}', f'{target_candidate}',
                     ...
                     f'{build_directory}', {executable_patterns}, f'{is_rng_in_different_folder}' '''
...
generic.add_cli_arguments(subparser, 'lattice', 'eaglesign',
                          'Specifications_and_Supporting_Documentation/Optimized_Implementation',
                          '""', '"../../../sign.h"',
                          '"../../../rng.h"')
...
ehtv3v4_default_list_of_folders = generic.get_default_list_of_folders(ehtv3v4_default_list_of_folders,
                                                                      default_tools_list)
...
biscuit_default_list_of_folders = generic.get_default_list_of_folders(biscuit_default_list_of_folders,
                                                                      default_tools_list)
...
# ================================================ dme_sign ===========================================
# [TODO:]
# each subfolder of DME-SIGN_nist-pqc-2023 has Reference_Implementation and Optimized_Implementaton folder
...
# dme_sign_default_list_of_folders = generic.get_default_list_of_folders(dme_sign_default_list_of_folders,
#                                                                        default_tools_list)
generic.add_cli_arguments(subparser, 'multivariate', 'dme_sign',
                          'DME-SIGN_nist-pqc-2023/dme-3rnds-8vars-32bits-sign/Optimized_Implementation',
                          '"../../../api.h"')
...
# ================================================= qr_uov ===============================================
qruov_default_list_of_folders = ["qruov1q7L10v740m100", "qruov1q31L3v165m60", "qruov1q31L10v600m70",
                                 "qruov1q127L3v156m54", "qruov3q7L10v1100m140", "qruov3q31L3v246m87",
                                 "qruov3q31L10v890m100", "qruov3q127L3v228m78", "qruov5q7L10v1490m190",
                                 "qruov5q31L3v324m114", "qruov5q31L10v1120m120", "qruov5q127L3v306m105"]
...
ascon_default_robust_and_simple_folders = generic.get_default_list_of_folders(ascon_default_robust_and_simple_folders,
                                                                              default_tools_list)
...
sphincs_default_list_of_folders = generic.get_default_list_of_folders(sphincs_default_list_of_folders,
                                                                      default_tools_list)
...
preon_default_128_192_256_folders = generic.get_default_list_of_folders(preon_default_128_192_256_folders,
                                                                        default_tools_list)
...
emle2_0_default_list_of_folders = generic.get_default_list_of_folders(emle2_0_default_list_of_folders,
                                                                      default_tools_list)
...
kaz_sign_default_list_of_folders = generic.get_default_list_of_folders(kaz_sign_default_list_of_folders,
                                                                       default_tools_list)
