...
def generic_target_compilation_02_fev(path_candidate: str, path_to_test_library_directory: str,
    ...
    for instance in instances_list:
        ...
        print("_________cflags_custom: ", cflags_custom)
...
def generic_benchmarks_init_compile_30_jan(candidate, abs_path_to_api_or_sign, abs_path_to_rng, optimized_imp_folder,
...
def generic_benchmarks_init_compile_01_fev(candidate, abs_path_to_api_or_sign, abs_path_to_rng, optimized_imp_folder,
                                    default_instance: str, instances, additional_includes,
                                    path_to_candidate_makefile_cmake, direct_link_or_compile_target: bool = True,
                                    cflags: Optional[Union[str, list]] = None,
                                    libraries_names: Union[str, list] = 'lbench',
...
def generic_benchmarks_init_compile_02_fev(candidate, abs_path_to_api_or_sign, abs_path_to_rng, optimized_imp_folder,
                                    default_instance: str, instances, additional_includes,
                                    path_to_candidate_makefile_cmake, direct_link_or_compile_target: bool = True,
                                    cflags: Optional[Union[str, list]] = None,
                                    libraries_names: Union[str, list] = 'lbench',
            ...
            if not instances:
                ...
                if build_with_make:
                    if candidate == 'pqov':
                        ...
                        for instance in instances:
                            print("---------compiling instance: ", instance)
                            print("---------(1): path_to_candidate_makefile_cmake: ", path_to_candidate_makefile_cmake)
                            path_to_candidate_makefile_cmake = path_to_candidate_makefile_cmake.replace(default_instance, instance)
                            print("---------(2): path_to_candidate_makefile_cmake: ", path_to_candidate_makefile_cmake)
                            gen.compile_target_candidate(path_to_candidate_makefile_cmake, build_with_make,
                                                         additional_cmake_definitions, *args, **kwargs)
                            path_to_candidate_makefile_cmake = path_to_candidate_makefile_cmake_initial
                else:
...
def generic_benchmarks_init_compile_05_fev(candidate, abs_path_to_api_or_sign, abs_path_to_rng, optimized_imp_folder,
                                    default_instance: str, instances, additional_includes,
                                    path_to_candidate_makefile_cmake, direct_link_or_compile_target: bool = True,
                                    cflags: Optional[Union[str, list]] = None,
                                    libraries_names: Union[str, list] = 'lbench',
