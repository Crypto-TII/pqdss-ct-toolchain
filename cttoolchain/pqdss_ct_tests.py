...
def generic_target_compilation(path_candidate: str, path_to_test_library_directory: str,
    ...
    print(":::::::::test_keypair_basename: ", test_keypair_basename)
    print(":::::::::test_sign_basename: ", test_sign_basename)
    keypair_sign = []
...
def compile_target_candidate_11_march(path_to_candidate_makefile_cmake: str,
...
def generic_init_compile_10_march(tools, candidate, abs_path_to_api_or_sign, abs_path_to_rng, optimized_imp_folder,
